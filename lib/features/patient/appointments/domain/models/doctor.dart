/// Doctor/profesional con disponibilidad para reservar (entidad de dominio).
class Doctor {
  Doctor({
    required this.id,
    required this.name,
  ...
  /// Returns the meeting type (VIRTUAL / IN_PERSON) of the slot that matches
  /// the given time (HH format:mm), or null if not found.
  ...
  /// Returns the full ISO datetime of the slot that matches the given time (HH
  /// format:mm), or an empty string if not found.
